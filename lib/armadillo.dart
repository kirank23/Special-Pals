    ...
    return Scaffold(
      body: Column(
        children: <Widget>[
          ...
          SizedBox(height: 25,),
          Text('Armadillo', style: TextStyle(
              color: Colors.black, fontWeight: FontWeight.bold, fontSize: 35, fontFamily: 'Nunito'
          ),),
          SizedBox(height: 10,),
          Text('Armadillo moms give birth \n    to eight to fifteen pups.', style: TextStyle(
          ...
          SizedBox(height: 25,),
          Text(
            'An Armadillo makes a squeal.',style: TextStyle(
...
Widget _step0(){
  return Container(
    ...
    child:  Center(
      child: Text(' Armadillos are barrel-shaped \n animals covered with natural armor.', style: TextStyle( fontWeight: FontWeight.w600,fontFamily: 'NunitoSans', fontSize: 18),),
    ),
  );
}
...
Widget _step1(){
  return Container(
    ...
    color: Colors.deepOrangeAccent[100],
    child:  Center(
      child: Text('In fact, its name in Spanish \n means “little armored one.”', style: TextStyle(fontWeight: FontWeight.w600,fontFamily: 'NunitoSans', fontSize: 18),),
    ),
  );
}
...
Widget _step2(){
  return Container(
    ...
    color: Colors.deepOrangeAccent[100],
    child:  Center(
      child: Text('Armadillos curl themselves into \n a ball if threatened.', style: TextStyle(fontWeight: FontWeight.w600,fontFamily: 'NunitoSans', fontSize: 18),),
    ),
  );
}
